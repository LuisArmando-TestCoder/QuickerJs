function quicker() {
  ...
  */
  ...
  function animationSet(startPoint, endPoint) {
    // startPoint: 'number' refers to the initial position
    // endPoint: 'number' refers to the final position
    const start = performance.now();
    const startP = startPoint, endP = endPoint - startPoint;
    function powerOfN(duration, curve) {
      // duration: 'number' represents how much will it grow until it reaches the <endPoint>
      // curve: 'number' to stretch out/in the curve
